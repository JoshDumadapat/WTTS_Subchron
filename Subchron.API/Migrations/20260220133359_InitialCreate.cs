        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_Role_Valid", "[Role] IN (1,2,3,4,5,6)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmpNumber = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    ...
                    AddressLine1 = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    ...
                    StateProvince = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    ...
                    EmergencyContactRelation = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserID", "CreatedAt", "Email", "EmailVerified", "ExternalId", "ExternalProvider", "IsActive", "LastLoginAt", "Name", "OrgID", "Password", "RecoveryCodesHash", "Role", "TotpSecret" },
                values: new object[] { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "ivanjoshdumadapat30@gmail.com", true, null, null, true, null, "Josh Dumadapat", null, "$2a$11$Aq6k23IxUxMsGwOMuwWQme7xSDkzu3N47OHmvsB44dQxdVLJLyMBe", null, 1, null });
