...
namespace Subchron.API.Migrations
{
    ...
    [Migration("20260221051444_EmployeeWorkStateAndArchiveAndAuditLogFields")]
    partial class EmployeeWorkStateAndArchiveAndAuditLogFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Subchron.API.Models.Entities.User", b =>
                {
                    ...
                    b.ToTable("Users", null, t =>
                        {
                            t.HasCheckConstraint("CK_Users_Role_Valid", "[Role] IN (1,2,3,4,5,6)");
                        });
